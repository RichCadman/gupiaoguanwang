...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">公司信息</a> </div>
        <h1>公司信息</h1>
    </div>
            ...
            <div class="span6">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Else/company_editor_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
                            <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                            <div class="control-group">
                                <label class="control-label">客服电话</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="tel" value="<?php echo ($info["tel"]); ?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">公司地址</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="address" value="<?php echo ($info["address"]); ?>" />
                                </div>
                            </div>
