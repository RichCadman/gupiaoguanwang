...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="../Index/index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">添加历史业绩</a> </div>
        <h1>添加历史业绩</h1>
    </div>
            ...
            <div class="span6">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Plan/history_editor_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
