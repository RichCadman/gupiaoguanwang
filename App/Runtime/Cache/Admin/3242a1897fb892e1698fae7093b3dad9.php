...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">关于我们横幅图片管理</a><a href="#" class="current">横幅图片总览</a> </div>
        <h1 style="float:left">横幅图片总览</h1>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        <div class="over"  >
                            <table class="table table-bordered data-table" style="overflow:hidden">
                                ...
                                <tr class="gradeX">
                                    <td>1</td>
                                    <td><a target="_blank" href="http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($info["banner_path"]); ?>">http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($info["banner_path"]); ?></a></td>
                                    <td><?php echo ($info["order_num"]); ?></td>
                                    <td width="300px;">
                                        <a href="/admin.php/Index/lunbo_editor/id/<?php echo ($info["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                </tr>
                                </tbody>
