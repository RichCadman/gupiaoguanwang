...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="work_index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">添加轮播图片</a> </div>
        <h1>添加轮播图片(<span style="color: red">图片大小必须一致</span>)</h1>
    </div>
            ...
            <div class="span6">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Index/add_lunbo_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
