...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">首页管理</a><a href="#" class="current">页面总览</a> </div>
        <h1 style="float:left">页面总览</h1>
    </div>
                        ...
                        <div class="over"  >
                            <table class="table table-bordered data-table" style="overflow:hidden">
                                ...
                                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                                        ...
                                        <td><a target="_blank" href="http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($v["img_path"]); ?>">http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($v["img_path"]); ?></a></td>
                                        <td><a target="_blank" href="http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($v["background_img"]); ?>">http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($v["background_img"]); ?></a></td>
                                        <?php if($v['order_num'] == 1): ?><td>第一部分</td>
                                        <?php elseif($v['order_num'] == 2): ?>
                                            <td>第二部分</td>
                                        <?php else: ?>
                                            <td>第三部分</td><?php endif; ?>
                                        <td width="300px;">
                                            <a href="/admin.php/Index/all_index_editor/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
