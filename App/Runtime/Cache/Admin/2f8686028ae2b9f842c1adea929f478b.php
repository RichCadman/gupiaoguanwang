...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">首页管理</a><a href="#" class="current">轮播图总览</a> </div>
        <h1 style="float:left">轮播图总览</h1>
    </div>
                        ...
                        <div class="over"  >
                            <table class="table table-bordered data-table" style="overflow:hidden">
                                ...
                                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                                        <td><?php echo ($k+1); ?></td>
                                        <td><a target="_blank" href="http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($v["banner_path"]); ?>">http://<?php echo ($_SERVER ['HTTP_HOST']); ?>/Pub/upload/<?php echo ($v["banner_path"]); ?></a></td>
                                        <td><?php echo ($v["time"]); ?></td>
                                        <td width="300px;">
                                            <a href="/admin.php/Index/lunbo_editor/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
