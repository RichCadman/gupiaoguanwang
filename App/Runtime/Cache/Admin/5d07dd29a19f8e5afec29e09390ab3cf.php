...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">E计划管理</a><a href="#" class="current">历史业绩总览</a> </div>
        <h1 style="float:left">历史业绩总览</h1>
    </div>
                        ...
                        <div class="over"  >
                            <table class="table table-bordered data-table" style="overflow:hidden">
                                ...
                                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr class="gradeX">
                                        ...
                                        <td width="300px;">
                                            <a href="/admin.php/Plan/history_editor/id/<?php echo ($v["id"]); ?>"><button class='btn btn-primary' style="margin-left:10px">编辑</button></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    function del(obj,id){
        // 发送sql语句
        if(confirm("确定删除吗？")){
            $.post('/admin.php/Plan/history_del',{id:id},function(data){
                // 判断是否成功
                if (data.statu==200) {
