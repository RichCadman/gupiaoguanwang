...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="work_index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改图片</a> </div>
        <h1>修改图片</h1>
    </div>
            ...
            <div class="span6">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Index/lunbo_editor_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
