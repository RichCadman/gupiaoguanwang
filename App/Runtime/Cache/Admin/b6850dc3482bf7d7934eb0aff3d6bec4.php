...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">修改页面</a> </div>
        <h1>修改页面</h1>
    </div>
            ...
            <div class="span6">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Index/all_index_editor_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
                            <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                            <div class="control-group">
                                <label class="control-label">标题</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="title" value="<?php echo ($info["title"]); ?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">内嵌图(<span style="color: red">不修改可不选择</span>)</label>
                                <div class="controls">
                                    <input type="file" name="img_path" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">背景图(<span style="color: red">不修改可不选择，建议图片大小：1920*920</span>)</label>
                                <div class="controls">
