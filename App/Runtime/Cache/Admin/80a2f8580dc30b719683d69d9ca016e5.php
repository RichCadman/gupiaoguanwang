...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="work_index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改二维码</a> </div>
        <h1>修改二维码</h1>
    </div>
            ...
            <div class="span6">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/Else/qrcode_editor_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
                            ...
                            <div class="control-group">
                                <label class="control-label">选择图片(<span style="color: red">建议图片大小：120*120</span>)</label>
                                <div class="controls">
