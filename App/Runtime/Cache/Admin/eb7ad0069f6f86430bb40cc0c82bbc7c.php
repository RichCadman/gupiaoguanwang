...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">修改联系我们</a> </div>
        <h1>修改联系我们</h1>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        <form action="/admin.php/About/editor_do" method="post" class="form-horizontal" enctype="multipart/form-data" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea name="content" ><?php echo ($contact["content"]); ?></textarea>
                                </div>
                            </div>
