...
<body class="index service eproject">
<!--header start-->
<header class="header">
    <div class="top cw">
...
<section class="sec4 tac">
    <div class="container">
        <ul>
            <li>
                <img src="/Pub/home/img/4.png">
                <p>跟着专业团队投资</p>
            </li>
            <li>
                <img src="/Pub/home/img/5.png">
                <p>专业投资策略</p>
            </li>
            <li>
                <img src="/Pub/home/img/6.png">
                <p>安心跟投，坐享收益</p>
            </li>
        </ul>
    </div>
